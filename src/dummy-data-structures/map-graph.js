export const mapGraph = {
  ...
  467: [
    ...
    { n: 399 },
    "Pirate Ry's",
    "You see a sign before you that reads:'You have found Pirate Ry's. Send a `change_name` request and I'll change your identity to whatever you wish... for a price.'",
    0,
    "NORMAL"
  ],
  463: [
...
export const hasBeenVisited = (i, j, visited) => {
  for (let key in visited) {
    let column = visited[key][0][0];
    let row = visited[key][0][1];
    let neighboringDirections = visited[key][1];
    if (column === i && row === j) {
      return [key, neighboringDirections];
    } else {
      continue;
    }
  }
